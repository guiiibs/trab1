...
void cria_mensagem_ack(mensagem *m, byte n);
void cria_mensagem_nack(mensagem *m, byte n);
void cria_mensagem_erro(mensagem *m, byte n, byte tipoErro);
void cria_mensagem_sucesso(mensagem *m, byte n);
